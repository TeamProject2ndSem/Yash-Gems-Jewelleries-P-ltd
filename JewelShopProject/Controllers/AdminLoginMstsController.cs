...
namespace JewelShopProject.Controllers
{
    public class AdminLoginMstsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdId,username,password")] AdminLoginMst adminLoginMst)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdId,username,password")] AdminLoginMst adminLoginMst)
        {
